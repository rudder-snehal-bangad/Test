...
",
    ...
    #"Columns removed by Measure Killer"= Table.RemoveColumns(Source,{"shipment_region_code", "return_reason", "shipment_country_code", "shipment_address_zip", "order_number", "gross_profit", "cost_price"})
in
